...
class DraftPublishChannelTestCase(StudioTestCase):
    ...
    def setUp(self):
        ...
        # Triggers Channel.on_update, which sets channel.version_info via get_or_create.
        increment_channel_version(self.channel)
        self.channel.refresh_from_db()
        ...
        self.original_version_info_id = self.channel.version_info.id
    ...
    def test_second_draft_publish_replaces_special_permissions_included(self):
        sp_node = self._make_sp_node("License A")
        ...
        # Second publish: node's description changes to "License B".
    ...
    def test_special_permissions_distributable_false_for_draft_publish(self):
        self._make_sp_node("Custom License")
